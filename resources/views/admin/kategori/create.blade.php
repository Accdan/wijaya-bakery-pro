                        ...
                        <form action="{{ route('kategori.store') }}" method="POST">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <textarea class="form-control @error('kategori_description') is-invalid @enderror"
                                          name="kategori_description" rows="3" required>{{ old('kategori_description') }}</textarea>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select class="form-control @error('kategori_status') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('kategori_status') == '1' ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ old('kategori_status') == '0' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
