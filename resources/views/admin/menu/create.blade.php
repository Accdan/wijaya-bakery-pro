                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nama_menu') is-invalid @enderror" name="nama_menu" value="{{ old('nama_menu') }}" required>
                                            @error('nama_menu')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>

                                        <div class="form-group">
                                            <label for="deskripsi_menu">Deskripsi</label>
                                            <textarea name="deskripsi_menu" class="form-control @error('deskripsi_menu') is-invalid @enderror" rows="3" required>{{ old('deskripsi_menu') }}</textarea>
                                            @error('deskripsi_menu')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>

                                        <div class="form-group">
                                            <label for="prosedur">Prosedur</label>
                                            <textarea name="prosedur" class="form-control @error('prosedur') is-invalid @enderror" rows="5" required>{{ old('prosedur') }}</textarea>
